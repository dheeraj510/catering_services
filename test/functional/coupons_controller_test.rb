...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { business_id: @coupon.business_id, coupon: @coupon.coupon, coupon_name: @coupon.coupon_name, coupon_status: @coupon.coupon_status, discount: @coupon.discount }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { business_id: @coupon.business_id, coupon: @coupon.coupon, coupon_name: @coupon.coupon_name, coupon_status: @coupon.coupon_status, discount: @coupon.discount }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
